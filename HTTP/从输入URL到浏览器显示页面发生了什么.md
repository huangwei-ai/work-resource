...
![Image text](https://images0.cnblogs.com/blog/622045/201507/020946553127518.png)
TCPIP
...
![Image text](http://images0.cnblogs.com/blog/622045/201507/020946557039933.png)
...
## 二、页面渲染
   ...
   DOM树是由HTML文件中的标签排列组成，渲染树是在DOM树中加入CSS或HTML中的style样式而形成。渲染树只包含需要显示在页面中的DOM元素，像head标签元素或display属性值为none的元素都不在渲染树中。
